@php
    ...
    $forgotPasswordUrl = env('APP_FRONT_END_FORGOT_PASSWORD_URL', 'https://seavphov-web.onrender.com/forgot-password');
@endphp
...
<body>
    <div class="container">
        ...
        <a href="{{ $forgotPasswordUrl }}" class="button" target="_blank">
            Reset Now
        </a>
